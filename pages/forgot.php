        ...
        <div class="login_sign_up_container">
            <div class="container">
                <div class="login_form_container">
                    ...
                    <p class="form_heading">Reset Your Password</p>
                    ...
                    <form class="login_form" method="post">
                        ...
                        <button type="submit" class="btn reset_password" id="reset_password">Reset Password</button>
                        <div class="m_link_container">
                            <p><a href="<?php echo $obj->base_url; ?>/login/">Login</a></p>
